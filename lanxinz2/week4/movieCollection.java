...
public class movieCollection {
    ...
    /**
     * this is a helper function to return all movie titles in the current page
    ...
    /**
     * this is a helper function to return the movie titles with a specific
     * genre ID in the current page
    ...
    /**
     * this is a helper function to return the movie titles whose vote
     * average exceeds a specific value in the current page
    ...
    /**
     * this is a helper function to return the movie titles whose
     * popularity exceeds a specific value in the current page
